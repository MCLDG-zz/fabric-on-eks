...
PEER_ORGS="org1"
PEER_DOMAINS="org1"
PEER_NAME="michaelpeer-${PEER_ORGS}"
...
EXTERNAL_ORDERER_ADDRESSES="        - ac236b7f8868711e88a810af1c0a30f8-fd736b6776569cb7.elb.us-west-2.amazonaws.com:7050
        - ac26a25e1868711e8834f06b86f026a6-45d4e4f5136eedb4.elb.us-west-2.amazonaws.com:7050
"
EXTERNAL_ANCHOR_PEER_ADDRESSES=" a06f1a90e868911e8834f06b86f026a6-6a077b82a884fc03.elb.us-west-2.amazonaws.com:7051 a0724e7c2868911e88a810af1c0a30f8-5cc52d786afe4111.elb.us-west-2.amazonaws.com:7051"
EXTERNAL_KAFKA_BROKER="- a28a9da6a868711e8834f06b86f026a6-2048376077.us-west-2.elb.amazonaws.com:9094"
EXTERNALORDERERHOSTNAME="ac26a25e1868711e8834f06b86f026a6-45d4e4f5136eedb4.elb.us-west-2.amazonaws.com"
EXTERNALORDERERPORT="7050"
...
function initOrdererVars {
   ...
   if [ $FABRIC_NETWORK_TYPE == "PROD" ] && [ $NUM -eq 2 ]; then
     export ORDERER_HOST=$EXTERNALORDERERHOSTNAME
     export ORDERER_PORT=$EXTERNALORDERERPORT
   else
